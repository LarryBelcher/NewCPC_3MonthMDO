...
def make_kml(llcrnrlon, llcrnrlat, urcrnrlon, urcrnrlat,
    ...
    for fig in figs:  # NOTE: Overlays are limited to the same bbox.
        ...
        ground.description = kw.pop(
            'description', 'Climate.gov Seasonal Drought Outlook; Data: CPC')
...
#Make the transparent version of the map
    ...
    mm = '01'#Hard code since we are not building dates in this routine anymore
    if(mm != '00'):
    ...
    ofile = 'Drought--ThreeMonth--Drought-Outlook--US--'+fnamedate+'_'
    altfile = 'Outlook--ThreeMonth--Drought--US--'+fnamedate+'_'
    ...
    make_kml(llcrnrlon=lllon, llcrnrlat=lllat, urcrnrlon=urlon, urcrnrlat=urlat, figs=[ofile+'transparent.png'], 
                kmzfile=ofile+'transparent.kmz', name='Drought Outlook for '+labdate)
    ...
    make_kml(llcrnrlon=lllon, llcrnrlat=lllat, urcrnrlon=urlon, urcrnrlat=urlat, figs=[ofile+'opaque.png'], 
                kmzfile=ofile+'opaque.kmz', name='Drought Outlook for '+labdate)
    ...
    make_kml(llcrnrlon=lllon, llcrnrlat=lllat, urcrnrlon=urlon, urcrnrlat=urlat, figs=[altfile+'transparent.png'], 
                kmzfile=altfile+'transparent.kmz', name='Drought Outlook for '+labdate)
    ...
    make_kml(llcrnrlon=lllon, llcrnrlat=lllat, urcrnrlon=urlon, urcrnrlat=urlat, figs=[altfile+'opaque.png'], 
                kmzfile=altfile+'opaque.kmz', name='Drought Outlook for '+labdate)
...
'''
    ...
    cmd = 'scp -i /home/ubuntu/.ssh/NewEarl.pem -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ./Drought*KML-assets.zip ubuntu@3.231.241.65:/var/www/Images/NewDSImages/Drought--ThreeMonth--Drought-Outlook--US/05-kml/'
    subprocess.call(cmd, shell=True)
    cmd = 'scp -i /home/ubuntu/.ssh/NewEarl.pem -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null ./Outlook*KML-assets.zip ubuntu@3.231.241.65:/var/www/Images/NewDSImages/Outlook--ThreeMonth--Drought--US/05-kml/'
    subprocess.call(cmd, shell=True)
    ...
    cmd = 'rm -rf files/'
    subprocess.call(cmd, shell=True)
    cmd = 'rm Drought--ThreeMonth--Drought-Outlook--US*.png'
    subprocess.call(cmd, shell=True)
    cmd = 'rm Outlook--ThreeMonth--Drought--US*.png'
    subprocess.call(cmd, shell=True)
